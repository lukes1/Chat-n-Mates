...
const char* BOARD_NAME = "ARDUINO_B";
const unsigned long SERIAL_BAUD = 115200;

const uint8_t PIN_HEAD_LR = 5;
const uint8_t PIN_HEAD_UD = 6;

ServoConfig servos[] = {
  {"HEAD_LR", PIN_HEAD_LR, 35, 145, 90},
  {"HEAD_UD", PIN_HEAD_UD, 20, 130, 80}
};
...
void setup() {
  ...
  Serial.println("READY ARDUINO_B");
}
